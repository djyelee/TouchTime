...
public class ReportViewActivity extends ActionBarActivity {
    ...
    private static AdapterView adapter_parent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // get all records in the database - the current year
                        ...
                        .withEndAction(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (ID > 0) {
                                    ...
                                    adapter_activity.notifyDataSetChanged();
                                    if ((lastClickId != -1) && (lastClickId != pos)) {
                                        adapter_parent.getChildAt(lastClickId).setBackgroundResource(R.color.svw_cyan);
